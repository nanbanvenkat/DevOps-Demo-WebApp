pipeline {
	 ...
	 stages {
		...
		steps{
		 ...
		 post {
                	always {
                  		jiraSendDeploymentInfo environmentId: 'Prod', environmentName: 'prod', environmentType: 'production', serviceIds: [''] , site: 'devopssquad12.atlassian.net', state: 'successful'
